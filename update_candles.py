...
# sem cair fora do gráfico conforme os dias passam.
...
def merge_history(existing, fresh, start_date):
    """Funde o histórico salvo com os dados frescos da API (a API é a
    fonte da verdade). Mantém tudo a partir de start_date — sem janela
    móvel, sem cortar dias antigos."""
...
def main():
    ...
    merged = merge_history(existing, fresh, START_DATE)
